...
exports.init = function(cfg) {
	...
	auth = {
		username: cfg.credentials.securenetId,
		password: cfg.credentials.securenetKey
	};

	url = (cfg.mode === 'live')? 'https://gwapi.securenet.com/api/' : 'https://gwapi.demo.securenet.com/api/';
	request.defaults({ auth: auth, json: true });
	config = config;
	return exports;
};
